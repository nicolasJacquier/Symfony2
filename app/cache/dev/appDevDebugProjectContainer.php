...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['db1'] = new \PDO('mysql:host=localhost;dbname=GSBPPE', 'root', 'mysql', array(3 => 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'GSBPPE', 'user' => 'root', 'password' => 'mysql', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        return $this->services['form.csrf_provider'] = new \Symfony\Component\Form\Extension\Csrf\CsrfProvider\SessionCsrfProvider($this->get('session'), 'GSBPPE');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'charset' => 'UTF8', 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/var/www/GSB_AHE/app/cache/dev/twig', 'paths' => array()));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('GSBPPE');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database.db1.dsn' => 'mysql:host=localhost;dbname=GSBPPE',
